...
// Approach: Take 2 array prefix and suffix array and precompute the 
// leftMax and rightMax for each index beforehand. Then use the formula 
// min(prefix[I], suffix[i])-arr[i] to compute water trapped at each index.
